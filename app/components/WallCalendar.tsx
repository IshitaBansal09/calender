  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center p-3 sm:p-6 transition-colors duration-700 ${
        isDark ? "bg-gray-900" : "bg-gradient-to-br from-amber-50 via-orange-50 to-stone-100"
      }`}
    >
      {/* Main calendar card */}
      <div
        className={`w-full max-w-5xl rounded-2xl overflow-hidden shadow-2xl theme-transition ${
      ...
      >
        ...
        <div className="flex justify-center gap-8 py-2 z-10 relative"
        ...
        <div className="flex flex-col md:flex-row md:min-h-[560px]">
          ...
          {/* Hero Image Panel */}
          <div className="w-full md:w-[240px] lg:w-[280px] flex-shrink-0 h-52 md:h-auto">
          ...
          <div className="flex-1 flex flex-col lg:flex-row">
            ...
            >
              ...
              {selectionStep === "idle" && !dateRange.start && (
                <div className={`text-xs text-center mb-2 py-1 ${isDark ? "text-gray-500" : "text-gray-400"}`}>
              ...
              <div className={`flex items-center gap-4 mt-3 pt-3 border-t text-xs ${
                isDark ? "border-gray-700 text-gray-400" : "border-black/10 text-gray-500"
              }`}>
                ...
                <div className="flex items-center gap-1.5">
                  <div className="w-3.5 h-3.5 rounded" style={{ backgroundColor: `${theme.accent}40` }} />
                  <span>Range</span>
                </div>
                <div className="flex items-center gap-1.5">
            ...
            <div
              ...
              style={{ backgroundColor: isDark ? "rgba(31,41,55,0.8)" : "rgba(255,253,245,0.8)" }}
            >
              <NotesPanel
                month={currentMonth}
                year={currentYear}
        ...
        {/* Footer */}
        <div
          className={`px-5 py-2 flex items-center justify-between text-xs theme-transition ${
            isDark ? "bg-gray-900/60 text-gray-500 border-t border-gray-700"
              : "bg-black/5 text-gray-400 border-t border-black/5"
          }`}
        >
          <span>Wall Calendar — {currentYear}</span>
          <div className="flex items-center gap-3">
            <span style={{ color: theme.accent }}>
              {MONTH_THEMES[currentMonth].season}
            </span>
            <button
        ...
        {showInfo && (
          <div
            className={`px-5 py-3 text-xs animate-fade-in theme-transition ${
              isDark ? "bg-gray-900/80 text-gray-400" : "bg-black/5 text-gray-500"
            }`}
          >
            <strong>Tips:</strong> Click once to pick start date, click again to set end date. Notes attach to your selection. Press Ctrl+Enter to save a note. Click any note to edit it.
          </div>
        )}
      </div>
    </div>
